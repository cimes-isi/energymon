...
* **jetson**: NVIDIA Jetson systems with INA3221 power sensors via Linux sysfs files (JetPack 4.x)
* **jetson-sensors**: NVIDIA Jetson systems with INA3221 power sensors via Linux sysfs files (JetPack 5.x)
